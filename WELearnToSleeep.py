...
#            print('发送心跳包～',end='')
            url = 'https://welearn.sflep.com/Ajax/SCO.aspx'
            req = session.post(url,data={'action':'keepsco_with_getticket_with_updatecmitime','uid':uid,'cid':cid,'scoid':scoid,'session_time':session_time,'total_time':total_time},headers={'Referer':'https://welearn.sflep.com/student/StudyCourse.aspx' })
#    print('增加学习时间～')
    url = 'https://welearn.sflep.com/Ajax/SCO.aspx'
